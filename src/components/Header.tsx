...
export function Header() {
	return <header class="flex gap-2 items-center p-3 border-b border-zinc-700 bg-zinc-900 z-10">
		<img src={miroImage} class="w-8 aspect-square rounded-full" />
		...
		<a href="https://www.linkedin.com/in/miro-stuyven-541b00190/" class="fill-current p-2" target="_blank">{Icons.linkedin}</a>
		<a href="https://github.com/mstuyven" class="fill-current p-2" target="_blank">{Icons.github}</a>
	</header>
}
